---
title: "AlphaQuant 中国股市量化交易系统 - 完整技术解析与实现指南"
date: 2026-02-04
...
class TradingCost:
    def __init__(self):
        ...
        self.transfer_fee = 0.000005  # 万分之 0.05 (过户费)
...
st.sidebar.selectbox("优化目标", ["收益最大化", "夏普最优化", "回撤最小化"])
```
